...
export class Footer extends Component {
  render() {
    return (
          <footer class="text-gray-600 body-font bg-veryPaleRed ">
               <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
               <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                    <a class="flex flex-col title-font font-medium items-center md:items-start md:justify-start justify-center text-gray-900">
               ...
               <div class="flex-grow flex flex-wrap justify-end md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    ...
                    <nav class="list-none mb-10">
                         <li>
                         <a class="text-gray-600 hover:text-gray-800">Copyright Policy</a>
                         </li>
                         <li>
                         ...
                         <li>
                         <a class="text-gray-600 hover:text-gray-800">Hyperlinking Policy</a>
                         </li>
                    </nav>
                    </div>
               </div>
               ...
               <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p class="text-gray-500 text-sm text-center sm:text-left">© Copyright 2022 —
                    <a href="#" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank">National Scholarship Portal</a>
                    </p>
                    <span class="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                    <a class="text-gray-500 cursor-pointer" target=" " href='https://www.facebook.com/ministryofsocial.justice.and.empowerment1'>
                         <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                         <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                         </svg>
                    </a>
                    <a class="ml-3 text-gray-500 cursor-pointer" target=" " href="https://twitter.com/msjegoi?lang=en">
                         <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                         <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                         </svg>
                    </a>
                    <a class="ml-3 text-gray-500 cursor-pointer" target=" " href='https://www.instagram.com/msjegoi/'>
