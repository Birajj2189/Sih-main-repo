...
export default class FreshLogin extends Component {
  render() {
    return (
     ...
     <section className="text-gray-500 body-font ">
       <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
         ...
         <div className=" shadow-md lg:w-2/6 md:w-1/2 bg-veryLightGray rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
           <h2 className="text-gray-900 text-2xl text-center font-medium title-font mb-5">Login for Fresh Application</h2>
           <div className="mb-4">
