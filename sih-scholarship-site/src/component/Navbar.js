      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:py-2 lg:py-6 md:justify-start md:space-x-10">
          ...
          <div className="-mr-2 -my-2 md:hidden md:-mr-0 lg:-mr-2">
            <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-brightRedLight">
          ...
          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
            ...
            <div className="py-6 px-5 space-y-6 bg-veryPaleRed">
              ...
              <div>
                <a
                  href="#"
                  className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-brightRed hover:bg-brightRedLight"
                >
                  Login
                </a>
