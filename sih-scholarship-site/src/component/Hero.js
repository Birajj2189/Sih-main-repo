  ...
  render() {
    return (
        <section class="text-gray-600 body-font">
          <div class="container mx-auto flex px-5 py-8 md:py-16 items-center justify-center flex-col">
            <img class="lg:w-3/6 lg:h-72 md:w-3/6 md:h-60 w-5/6 h-56 mb-6 md:m-10 object-cover object-center rounded" alt="hero" src="https://dummyimage.com/720x600"/>
