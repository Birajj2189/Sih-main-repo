    ...
    <div className="flex mx-auto flex-wrap mb-20">
     ...
     <div className="flex justify-center items-center form-container w-full">
          <form className="w-full md:w-3/4 lg:w-1/2 bg-transparent " action="#" method="POST">
               ...
               <h1 className='bg-white text-3xl w-full text-center text-gray-900 py-6 rounded'>Famly Income Verification</h1>
               ...
               <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                    ...
                    <Link to="/scholarships/ITR-Verification" className="whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white  bg-brightRed hover:bg-brightRedLight"
                    >
                    Next
                    </Link>
                    </div>
