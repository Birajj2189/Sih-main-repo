...
export default function DomicileVerification() {
  return (
     ...
     <a className="sm:px-6 py-3 w-1/2 sm:w-auto justify-center sm:justify-start border-b-2 title-font font-medium inline-flex items-center leading-none border-gray-200 hover:text-gray-900 tracking-wider">
      ...
      <div className="flex justify-center items-center form-container w-full">
           <form className="w-full md:w-3/4 lg:w-1/2 bg-transparent " action="#" method="POST">
                ...
                <h1 className='bg-white text-3xl w-full text-center text-gray-900 py-6 rounded'>Domicile Verification</h1>
                ...
                <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                     ...
                     <Link to="/scholarships/Dashboard" className="whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white  bg-brightRed hover:bg-brightRedLight"
                     >
                         Submit
                     </Link>
                     </div>
